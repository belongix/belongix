...
(function () {
  ...
  var CSS = `
    ...
    #bexi-win{position:fixed;bottom:calc(80px + env(safe-area-inset-bottom));right:24px;width:360px;max-height:520px;background:#fff;border-radius:20px;border:1px solid #E4E4F0;box-shadow:0 20px 64px rgba(45,27,105,.2);z-index:9997;display:none;flex-direction:column;overflow:hidden;font-family:'DM Sans',sans-serif}
